...
const listMessage = {
 ...
 let mode = global.opts['self'] ? 'Private' : 'Publik'
  ...
  let fkon = { key: { fromMe: false, participant: `${m.sender.split`@`[0]}@s.whatsapp.net`, ...(m.chat ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { contactMessage: { displayName: `${name}`, vcard: `BEGIN:VCARD\nVERSION:3.0\nN:;a,;;;\nFN:${name}\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`}}}
    ...
    await conn.sendButtonDoc(m.chat, text, '📮 Note: Jangan Spam Dan Telpon, Jika Melanggar Bisa Kena Banned Permanent!', 'Owner', '.owner', m, { 
     quoted: ftoko, 
     contextInfo: { forwardingScore: 99999, isForwarded: true, 
         externalAdReply: { 
             ...
             mediaType: 2, 
           thumbnail: await (await fetch(`https://telegra.ph/file/d746c17f83afada64c54f.jpg`)).buffer(),
          mediaUrl: `https://github.com/XCoreBot`
         } 
      } 
     })
